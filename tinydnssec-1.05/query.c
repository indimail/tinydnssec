...
NEWNAME:
	...
	if (dns_domain_equal
		(d,
		 "\0011\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\003ip6\003int\0"))
	{
		if (z->level)
			goto LOWERLEVEL;
		if (!rqa(z))
		...
		if (typematch(DNS_T_PTR, dtype)) {
			if (!response_rstart(d, DNS_T_PTR, 655360))
				goto DIE;
			if (!response_addname("\016ipv6-localhost\0"))
				goto DIE;
			if (!response_addname("\015ipv6-loopback\0"))
				goto DIE;
			response_rfinish(RESPONSE_ANSWER);
		}
		cleanup(z);
	...
	if (dns_domain_equal
		(d,
		 "\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\001e\001f\003ip6\003int\0"))
	{
		if (z->level)
			goto LOWERLEVEL;
		if (!rqa(z))
		...
		if (typematch(DNS_T_PTR, dtype)) {
			if (!response_rstart(d, DNS_T_PTR, 655360))
				goto DIE;
			if (!response_addname("\015ipv6-localnet\0"))
				goto DIE;
			response_rfinish(RESPONSE_ANSWER);
		}
		cleanup(z);
	...
	if (dns_domain_equal
		(d,
		 "\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\001f\001f\003ip6\003int\0"))
	{
		if (z->level)
			goto LOWERLEVEL;
		if (!rqa(z))
		...
		if (typematch(DNS_T_PTR, dtype)) {
			if (!response_rstart(d, DNS_T_PTR, 655360))
				goto DIE;
			if (!response_addname("\020ipv6-mcastprefix\0"))
				goto DIE;
			response_rfinish(RESPONSE_ANSWER);
		}
		cleanup(z);
	...
	if (dns_domain_equal
		(d,
		 "\0011\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0012\0010\001f\001f\003ip6\003int\0"))
	{
		if (z->level)
			goto LOWERLEVEL;
		if (!rqa(z))
		...
		if (typematch(DNS_T_PTR, dtype)) {
			if (!response_rstart(d, DNS_T_PTR, 655360))
				goto DIE;
			if (!response_addname("\015ipv6-allnodes\0"))
				goto DIE;
			response_rfinish(RESPONSE_ANSWER);
		}
		cleanup(z);
	...
	if (dns_domain_equal
		(d,
		 "\0012\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0012\0010\001f\001f\003ip6\003int\0"))
	{
		if (z->level)
			goto LOWERLEVEL;
		if (!rqa(z))
		...
		if (typematch(DNS_T_PTR, dtype)) {
			if (!response_rstart(d, DNS_T_PTR, 655360))
				goto DIE;
			if (!response_addname("\017ipv6-allrouters\0"))
				goto DIE;
			response_rfinish(RESPONSE_ANSWER);
		}
		cleanup(z);
		 ...
		 "\0011\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0010\0012\0010\001f\001f\003ip6\003int\0"))
	{
		...
		if (typematch(DNS_T_PTR, dtype)) {
			if (!response_rstart(d, DNS_T_PTR, 655360))
				goto DIE;
			if (!response_addname("\015ipv6-allhosts\0"))
				goto DIE;
			response_rfinish(RESPONSE_ANSWER);
		}
		cleanup(z);
	...
	if (dns_domain_equal(d, "\016ipv6-localhost\0") || dns_domain_equal(d, "\015ipv6-loopback\0")) {
		if (z->level)
			goto LOWERLEVEL;
		if (!rqa(z))
			goto DIE;
		if (typematch(DNS_T_AAAA, dtype)) {
			if (!response_rstart(d, DNS_T_AAAA, 655360))
				goto DIE;
			if (!response_addbytes("\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\001", 16))
				goto DIE;
			response_rfinish(RESPONSE_ANSWER);
		}
		cleanup(z);
	...
	if (dns_domain_equal(d, "\015ipv6-localnet\0")) {
		...
		if (typematch(DNS_T_AAAA, dtype)) {
			if (!response_rstart(d, DNS_T_AAAA, 655360))
				goto DIE;
			if (!response_addbytes("\376\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000", 16))
				goto DIE;
			response_rfinish(RESPONSE_ANSWER);
		}
		cleanup(z);
	...
	if (dns_domain_equal(d, "\020ipv6-mcastprefix\0")) {
		...
		if (typematch(DNS_T_AAAA, dtype)) {
			if (!response_rstart(d, DNS_T_AAAA, 655360))
				goto DIE;
			if (!response_addbytes("\377\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000", 16))
				goto DIE;
			response_rfinish(RESPONSE_ANSWER);
		}
		cleanup(z);
	...
	if (dns_domain_equal(d, "\15ipv6-allnodes\0")) {
		...
		if (typematch(DNS_T_AAAA, dtype)) {
			if (!response_rstart(d, DNS_T_AAAA, 655360))
				goto DIE;
			if (!response_addbytes("\377\002\000\000\000\000\000\000\000\000\000\000\000\000\000\001", 16))
				goto DIE;
			response_rfinish(RESPONSE_ANSWER);
		}
		cleanup(z);
	...
	if (dns_domain_equal(d, "\17ipv6-allrouters\0")) {
		...
		if (typematch(DNS_T_AAAA, dtype)) {
			if (!response_rstart(d, DNS_T_AAAA, 655360))
				goto DIE;
			if (!response_addbytes("\377\002\000\000\000\000\000\000\000\000\000\000\000\000\000\002", 16))
				goto DIE;
			response_rfinish(RESPONSE_ANSWER);
		}
		cleanup(z);
	...
	if (dns_domain_equal(d, "\15ipv6-allhosts\0")) {
		...
		if (typematch(DNS_T_AAAA, dtype)) {
			if (!response_rstart(d, DNS_T_AAAA, 655360))
				goto DIE;
			if (!response_addbytes("\377\002\000\000\000\000\000\000\000\000\000\000\000\000\000\003", 16))
				goto DIE;
			response_rfinish(RESPONSE_ANSWER);
		}
		cleanup(z);
	...
	if (dlen <= 255) {
		...
		if (typematch(DNS_T_AAAA, dtype)) {
			...
			if (cached && (cachedlen || byte_diff(dtype, 2, DNS_T_ANY))) {
				...
				if (!rqa(z))
					goto DIE;
				while (cachedlen >= 16) {
					if (!response_rstart(d, DNS_T_AAAA, ttl))
						goto DIE;
					if (!response_addbytes(cached, 16))
						goto DIE;
					response_rfinish(RESPONSE_ANSWER);
					cached += 16;
					cachedlen -= 16;
		...
		if (!typematch(DNS_T_ANY, dtype) && !typematch(DNS_T_AXFR, dtype) && !typematch(DNS_T_CNAME, dtype)
			...
			&& !typematch(DNS_T_MX, dtype) && !typematch(DNS_T_AAAA, dtype) && !typematch(DNS_T_SOA, dtype)) {
...
HAVENS:
	...
	if (z->level) {
		...
		if (dns_transmit_start(&z->dt, z->servers[z->level], flagforwardonly, z->name[z->level], dtype, z->localip) == -1)
			goto DIE;
	} else {
		...
		if (byte_equal(type, 2, DNS_T_ANY));
			...
			while (i < j) {
				...
				if (byte_equal(header + 8, 2, "\0\20")) {
					pos = dns_packet_copy(buf, len, pos, header, 16);
					if (!pos)
						goto DIE;
					if (ignoreip.len)
						for (ii = 0; ii < ignoreip.len; ii += 16)
							if (byte_equal(header, 16, ignoreip.s + ii))
								goto NXDOMAIN;
					save_data(header, 16);
...
int
query_start(struct query *z, char *dn, char type[2], char class[2], char localip[16], unsigned int scope_id)
{
